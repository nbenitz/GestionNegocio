...
namespace ControlDoor
{
    class TypeMap
    {
        ...
        public static void OperationMinorTypeMap(CHCNetSDK2.NET_DVR_LOG_V30 stLogInfo, char[] csTmp)
        {
            String szTemp = null;

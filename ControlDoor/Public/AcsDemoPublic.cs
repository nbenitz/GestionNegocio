...
namespace ControlDoor
{
    ...
    public class AcsDemoPublic
    {
        ...
        public struct STRU_DEVICE_INFO
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = CHCNetSDK0.NAME_LEN)]
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.MAX_AUDIO_V40)]
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.MAX_CHANNUM_V40, ArraySubType = UnmanagedType.Struct)]
            public STRU_CHANNEL_INFO[] pStruChanInfo; //channel structure
            public CHCNetSDK0.NET_DVR_IPPARACFG_V40[] pStruIPParaCfgV40;    //IP channel parameters
            public CHCNetSDK0.NET_DVR_IPALARMINCFG struAlarmInCfg;
            public CHCNetSDK0.NET_DVR_IPALARMINCFG_V40 pStruIPAlarmInCfgV40;  // IP alarm In parameters
            public CHCNetSDK0.NET_DVR_IPALARMOUTCFG_V40 pStruIPAlarmOutCfgV40; // IP alarm Out parameters
            public CHCNetSDK0.NET_DVR_IPALARMOUTCFG struAlarmOutCfg;
            public IntPtr pNext;
            ...
            public int iDoorNum;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3 * CHCNetSDK0.MAX_DOOR_NUM_256, ArraySubType = UnmanagedType.I1)]
            public int[] iDoorStatus;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.MAX_DOOR_NUM_256, ArraySubType = UnmanagedType.ByValTStr)]
            ...
            public void Init()
            {
                ...
                iDeviceChanNum = -1;
                iDoorNum = -1;
                iDoorStatus = new int[3 * CHCNetSDK0.MAX_DOOR_NUM_256];
                sDoorName = new string[CHCNetSDK0.MAX_DOOR_NUM_256];
                iStartChan = 0;
                iDeviceType = 0;
                iDiskNum = 0;
                lDevicePort = 8000;
                ...
                bPlayDevice = false;
                bVoiceTalk = false;
                //lAudioHandle = new Int32[CHCNetSDK0.MAX_AUDIO_V40];
                //bCheckBroadcast = new bool[CHCNetSDK0.MAX_AUDIO_V40];
                lFortifyHandle = -1;
                bAlarm = false;
                iDeviceLoginType = 0;
                ...
                bIPRet = false;
                pNext = IntPtr.Zero;
                //lVoiceCom = new Int32[CHCNetSDK0.MAX_AUDIO_V40];
                ...
                //lAudioHandle[0] = -1;
                //lAudioHandle[1] = -1;
                //pStruChanInfo = new STRU_CHANNEL_INFO[CHCNetSDK0.MAX_CHANNUM_V40];
                //struZeroChan = new STRU_CHANNEL_INFO[16];
                //struMirrorChan = new STRU_CHANNEL_INFO[16];
                //pStruIPAlarmInCfgV40 = new CHCNetSDK0.NET_DVR_IPALARMINCFG_V40();
                //pStruIPAlarmOutCfgV40 = new CHCNetSDK0.NET_DVR_IPALARMOUTCFG_V40();
                //struAlarmInCfg = new CHCNetSDK0.NET_DVR_IPALARMINCFG();
                //struAlarmOutCfg = new CHCNetSDK0.NET_DVR_IPALARMOUTCFG();
        ...
        public static bool CheckState(CHCNetSDK0.NET_DVR_DATE struItem)
        {
        ...
        public static bool CheckDate(CHCNetSDK0.NET_DVR_SIMPLE_DAYTIME struItem)
        {

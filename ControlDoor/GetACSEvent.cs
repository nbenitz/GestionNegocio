...
namespace ControlDoor
{
    public partial class GetACSEvent : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            m_lGetAcsEventHandle = CHCNetSDK.NET_DVR_StartRemoteConfig(
                m_UserID, 
        ...
        public void ProcessEvent()
        {
            ...
            while (Flag)
            {
                ...
                switch (dwStatus)
                {
                    case CHCNetSDK.NET_SDK_GET_NEXT_STATUS_SUCCESS://Una vez que los datos se leen con éxito, se debe llamar después de procesar los datos

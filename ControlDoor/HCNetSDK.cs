...
namespace ControlDoor
{
    public class CHCNetSDK0
    {
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            public void Init()
            {
                byDoorRight = new byte[CHCNetSDK0.MAX_DOOR_NUM_256];
                byBelongGroup = new byte[CHCNetSDK0.MAX_GROUP_NUM_128];
                wCardRightPlan = new ushort[CHCNetSDK0.MAX_DOOR_NUM_256 * CHCNetSDK0.MAX_CARD_RIGHT_PLAN_NUM];
                byCardNo = new byte[CHCNetSDK0.ACS_CARD_NO_LEN];
                byCardPassword = new byte[CHCNetSDK0.CARD_PASSWORD_LEN];
                byName = new byte[CHCNetSDK0.NAME_LEN];
                byRes2 = new byte[3];               
                byLockCode = new byte[CHCNetSDK0.MAX_LOCK_CODE_LEN];
                byRoomCode = new byte[CHCNetSDK0.MAX_DOOR_CODE_LEN];
                byRes3 = new byte[83];
            }
        }
        ...
        {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.MAX_CARD_READER_NUM_512, ArraySubType = UnmanagedType.I1)]
            public byte[] byEnableCardReader;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.MAX_FACE_NUM, ArraySubType = UnmanagedType.I1)]
            ...
            {
                byCardNo = new byte[CHCNetSDK0.ACS_CARD_NO_LEN];
                byEnableCardReader = new byte[CHCNetSDK0.MAX_CARD_READER_NUM_512];
                byFaceID = new byte[CHCNetSDK0.MAX_FACE_NUM];
                byRes1 = new byte[42];
            }
        }
        ...
        public struct NET_DVR_ACS_EVENT_COND
        {
            ...
            public uint dwMajor;
            public uint dwMinor;
            public CHCNetSDK0.NET_DVR_TIME struStartTime;
            public CHCNetSDK0.NET_DVR_TIME struEndTime;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byName;
            ...
            public byte byRes1;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = CHCNetSDK0.NET_SDK_MONITOR_ID_LEN)]
            public string szMonitorID;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.NET_SDK_EMPLOYEE_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byEmployeeNo;
            ...
            public void Init()
            {
                ...
                byName = new byte[CHCNetSDK0.NAME_LEN];
                byRes2 = new byte[2];
                byEmployeeNo=new byte[CHCNetSDK0.NET_SDK_EMPLOYEE_NO_LEN];
                byRes = new byte[140];
            }
        }
        ...
        public struct NET_DVR_ACS_EVENT_CFG
        {
            ...
            public uint dwMajor;
            public uint dwMinor;
            public CHCNetSDK0.NET_DVR_TIME struTime;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.MAX_NAMELEN)]
            public byte[] sNetUser;
            public CHCNetSDK0.NET_DVR_IPADDR struRemoteHostAddr;
            public CHCNetSDK0.NET_DVR_ACS_EVENT_DETAIL struAcsEventInfo;
        ...
        {
            public uint dwSize;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.ACS_CARD_NO_LEN)]
            public byte[] byCardNo;
            public byte byCardType;
            ...
            public byte byType;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.MACADDR_LEN)]
            public byte[] byMACAddr;
            ...
            public byte[] byRe2;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK0.NET_SDK_EMPLOYEE_NO_LEN)]
            public byte[] byEmployeeNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)]
            public byte[] byRes;
        }
        ...
        [DllImport(@"..\..\..\HCNetSDK\HCNetSDK.dll")]
        public static extern bool NET_DVR_CaptureJPEGPicture(int lUserID, int lChannel,ref CHCNetSDK0.NET_DVR_JPEGPARA lpJpegPara,IntPtr sPicFileName);
        #endregion
    ...
    public class CHCNetSDK2
    {
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            public void Init()
            {
                byDoorRight = new byte[CHCNetSDK2.MAX_DOOR_NUM_256];
                byBelongGroup = new byte[CHCNetSDK2.MAX_GROUP_NUM_128];
                wCardRightPlan = new ushort[CHCNetSDK2.MAX_DOOR_NUM_256 * CHCNetSDK2.MAX_CARD_RIGHT_PLAN_NUM];
                byCardNo = new byte[CHCNetSDK2.ACS_CARD_NO_LEN];
                byCardPassword = new byte[CHCNetSDK2.CARD_PASSWORD_LEN];
                byName = new byte[CHCNetSDK2.NAME_LEN];
                byRes2 = new byte[3];
                byLockCode = new byte[CHCNetSDK2.MAX_LOCK_CODE_LEN];
                byRoomCode = new byte[CHCNetSDK2.MAX_DOOR_CODE_LEN];
                byRes3 = new byte[83];
            }
        }
        ...
        public struct NET_DVR_FACE_PARAM_BYCARD
        {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.MAX_CARD_READER_NUM_512, ArraySubType = UnmanagedType.I1)]
            public byte[] byEnableCardReader;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.MAX_FACE_NUM, ArraySubType = UnmanagedType.I1)]
            public byte[] byFaceID;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 42, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
            ...
            {
                byCardNo = new byte[CHCNetSDK2.ACS_CARD_NO_LEN];
                byEnableCardReader = new byte[CHCNetSDK2.MAX_CARD_READER_NUM_512];
                byFaceID = new byte[CHCNetSDK2.MAX_FACE_NUM];
                byRes1 = new byte[42];
            }
        }
        ...
        public struct NET_DVR_ACS_EVENT_COND
        {
            ...
            public uint dwMajor;
            public uint dwMinor;
            public CHCNetSDK2.NET_DVR_TIME struStartTime;
            public CHCNetSDK2.NET_DVR_TIME struEndTime;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byName;
            public uint dwBeginSerialNo;
            public byte byPicEnable;
            public byte byTimeType;
            ...
            public byte bySearchType;
            public byte byRes1;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = CHCNetSDK2.NET_SDK_MONITOR_ID_LEN)]
            public string szMonitorID;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.NET_SDK_EMPLOYEE_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byEmployeeNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 140, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
            ...
            public void Init()
            {
                ...
                byName = new byte[CHCNetSDK2.NAME_LEN];
                byRes2 = new byte[2];
                byEmployeeNo = new byte[CHCNetSDK2.NET_SDK_EMPLOYEE_NO_LEN];
                byRes = new byte[140];
            }
        }
        ...
        public struct NET_DVR_ACS_EVENT_CFG
        {
            ...
            public uint dwMajor;
            public uint dwMinor;
            public CHCNetSDK2.NET_DVR_TIME struTime;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.MAX_NAMELEN)]
            public byte[] sNetUser;
            public CHCNetSDK2.NET_DVR_IPADDR struRemoteHostAddr;
            public CHCNetSDK2.NET_DVR_ACS_EVENT_DETAIL struAcsEventInfo;
            public uint dwPicDataLen;
            public IntPtr pPicData;  // picture data
            public ushort wInductiveEventType;
            public byte byTimeType;
        ...
        {
            public uint dwSize;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.ACS_CARD_NO_LEN)]
            public byte[] byCardNo;
            public byte byCardType;
            public byte byWhiteListNo;
            public byte byReportChannel;
            ...
            public byte byInternetAccess;
            public byte byType;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.MACADDR_LEN)]
            public byte[] byMACAddr;
            public byte bySwipeCardType;
            public byte byRes2;
            public uint dwSerialNo;
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] byRe2;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.NET_SDK_EMPLOYEE_NO_LEN)]
            public byte[] byEmployeeNo;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)]
            public byte[] byRes;
        }
        ...
        [DllImport(@"..\..\..\HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_GetNextRemoteConfig(int lHandle, ref CHCNetSDK2.NET_DVR_CAPTURE_FINGERPRINT_CFG lpOutBuff, int dwOutBuffSize);
        /* Batch for device configuration information (with sending data)
         * [in] lUserID - NET_DVR_Login_V40 return value
         * [in] dwCommand - the configuration command(usually with NET_DVR_ prefix)
         * [in] dwCount - the number of configuration at a time, 0 and 1 represent one, in order to increase, maximum:64
        ...
        [DllImport(@"..\..\..\HCNetSDK\HCNetSDK.dll")]
        public static extern bool NET_DVR_CaptureJPEGPicture(int lUserID, int lChannel, ref CHCNetSDK2.NET_DVR_JPEGPARA lpJpegPara, IntPtr sPicFileName);
        #endregion
        ...
        public struct NET_DVR_FINGERPRINT_COND
        {
            public int dwSize;           //tamaño de la estructura
            public int dwFingerprintNum;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.ACS_CARD_NO_LEN)] //Número de huellas dactilares(0xffffffff cuando se adquieren huellas dactilares, lo que indica que se adquiere toda la información de huellas dactilares)
            public byte[] byCardNo;      //El número de tarjeta asociado con la huella digital
            public int dwEnableReaderNo; //Número de lector de huellas dactilares
            public byte byFingerPrintID; //Número de huella digital, rango de valores: 1~10 (0xff significa todas las huellas digitales de la tarjeta)
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 131)]
            public byte[] byRes;         //reservado, establecido en 0
        ...
        {
            public int dwSize;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.ACS_CARD_NO_LEN)]
            public byte[] byCardNo; //指纹关联的卡号
            ...
            public byte[] byRes1;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.MAX_FINGER_PRINT_LEN)]
            public byte[] byFingerData;
            ...
            public void init()
            {
                byCardNo = new byte[CHCNetSDK2.ACS_CARD_NO_LEN];
                byRes1 = new byte[30];
                byFingerData = new byte[CHCNetSDK2.MAX_FINGER_PRINT_LEN];
                byRes = new byte[96];
            }
        }
        ...
        public struct NET_DVR_FINGERPRINT_STATUS
        {
            ...
            public byte byFingerType;//指纹类型  0-普通指纹，1-胁迫指纹
            public byte byRecvStatus;//主机错误状态：0-成功，1-手指编号错误，2-指纹类型错误，3-卡号错误（卡号规格不符合设备要求），4-指纹未关联工号或卡号（工号或卡号字段为空），5-工号不存在，6-指纹数据长度为0，7-读卡器编号错误，8-工号错误
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = CHCNetSDK2.ERROR_MSG_LEN)]
            public byte[] byErrorMsg;//下发错误信息，当byCardReaderRecvStatus为5时，表示已存在指纹对应的卡号
            ...
            {
                byCardNo = new byte[CHCNetSDK2.ACS_CARD_NO_LEN];
                byErrorMsg = new byte[CHCNetSDK2.ERROR_MSG_LEN];
        ...
        [DllImport(@"..\..\..\HCNetSDK\HCNetSDK.dll")]
        public static extern int NET_DVR_SendWithRecvRemoteConfig(int lHandle, ref CHCNetSDK2.NET_DVR_FINGERPRINT_RECORD lpInBuff, int dwInBuffSize, ref CHCNetSDK2.NET_DVR_FINGERPRINT_STATUS lpOutBuff, int dwOutBuffSize, IntPtr dwOutDataLen);

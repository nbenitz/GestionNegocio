...
Public Class FNuevoPrivilegioGym
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Dim MembresiaAdmin As Boolean = chkMembresia.Checked
        Dim AccesoAdmin As Boolean = chkAcceso.Checked
        If Rol <> "" Then
    ...
    Public Sub Editar(ByVal Rol As String,
        ...
        chkMembresia.Checked = MembresiaAdmin
        chkAcceso.Checked = AccesoAdmin
        IdPrivilegio = IdPriv

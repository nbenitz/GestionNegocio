...
Public Class FVentaGym
    ...
    Private Sub pbxBuscCli_Click(ByVal sender As Object, ByVal e As EventArgs) Handles pbxBuscCli.Click
    ...
    Private Sub optCod_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles optCod.Click, optDesc.Click,
        txtFecha.Click, txtNroFac.Click, txtTotal.Click, DataGridView1.Click, pbxBuscCli.Click,
